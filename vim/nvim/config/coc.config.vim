...
" extensions
let g:coc_global_extensions = ['coc-python', 'coc-java', 'coc-tslint-plugin', 'coc-tsserver', 'coc-emmet', 'coc-css', 'coc-html', 'coc-json', 'coc-yank', 'coc-prettier', 'coc-highlight', 'coc-lists', 'coc-flutter']
